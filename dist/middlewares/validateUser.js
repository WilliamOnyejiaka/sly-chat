...
const validateUser = (cache, repo) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!cacheResult.data) {
        const user = yield repo.getUserWithId(id);
        if (user.error) {
            res.status(404).json({
                error: true,
                message: (0, constants_1.default)('404User')
            });
            return;
        }
        if (!user.data) {
